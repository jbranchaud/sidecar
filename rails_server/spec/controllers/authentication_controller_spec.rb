  ...
  describe 'PUT #reset_password' do
    ...
    context 'when reset token is valid' do
      it "responds with a 200 and updates the user's password" do
        put :reset_password, params: { reset_token: reset_token, password: new_password, password_confirmation: new_password, format: :json}
    ...
    context 'when reset token is valid and passwords do not match' do
      it "responds with a 400" do
        ...
        put :reset_password, params: { reset_token: reset_token, password: new_password, password_confirmation: mismatched_password, format: :json}
    ...
    context 'when reset token is invalid' do
      it "responds with a 404" do
        ...
        put :reset_password, params: { reset_token: some_token, password: new_password, password_confirmation: new_password, format: :json}
